    ...
    <table class="table table-bordered" id="CitizensAdminIndexTable">
        ...
        <tbody>
            ...
            <tr<?php echo $class; ?>>
                ...
                <td>
                    <div class="btn-group">
                                <?php echo $this->Html->link(__('View', true), array('action' => 'view', $item['Citizen']['id']), array('class' => 'btn btn-default dialogControl')); ?>
                                <?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $item['Citizen']['id']), array('class' => 'btn btn-default dialogControl')); ?>
                                <?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $item['Citizen']['id']), array('class' => 'btn btn-default'), __('Delete the item, sure?', true)); ?>
                    </div>
                </td>
            </tr>
